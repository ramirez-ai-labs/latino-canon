...
| *Apocalypse Z: The Beginning of the End* (2024) | Director Carles Torrens is Spanish, which now qualifies | Zombie horror genre film — no cultural specificity; removing the Spanish setting wouldn't change the story. Same call as *From Dusk till Dawn*: `led_by` alone (even if earned) would be a thin, technicality-only claim without `about_community`. |
| *Agent Zeta* (2026) | Director Dani de la Torre is confirmed Spanish | Globe-trotting spy thriller — same genre-film-in-a-Latin-setting exclusion as *Apocalypse Z*. |
